...
const TemplateDocuments = () => {
	...
	return (
		<div style={style} className={classes.DocumentsContainer}  id="documentcontainer">
			...
			<TemplateDocument content = {single_column} title = "Copy of Single Column Research Paper Template" heading ="Single Column Research Paper Template"></TemplateDocument>
			<TemplateDocument content = {double_column} title = "Copy of Double Column Research Paper Template" heading ="Double Column Research Paper Template"></TemplateDocument>
		</div>
	);
};
